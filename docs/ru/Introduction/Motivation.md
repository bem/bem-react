# Мотивация. Зачем вам bem-react-core
...
Применение Hight Order Components при композиции компонентов, которые отвечают за разные аспекты функциональности, приводит к «раздутию» виртуального дерева.
