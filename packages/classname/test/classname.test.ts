...
describe('@bem-react/classname', () => {
  describe('cn', () => {
    ...
    describe('mix', () => {
      ...
      it('carry elem with mods', () => {
        const b = cn('Block')
        expect(b('Elem', { theme: 'normal' }, ['Mix'])).to.be.eq(
      ...
      it('unique block with mods', () => {
        const b = cn('Block')
        expect(b({ theme: 'normal' }, ['Block Block_size_m'])).to.be.eq(
      ...
      it('unique elem with mods', () => {
        const b = cn('Block')
        expect(b('Elem', { theme: 'normal' }, ['Block-Elem Block-Elem_size_m'])).to.be.eq(
  ...
  describe('withNaming custom preset', () => {
    ...
    it('variants', () => {
      ...
      expect(block('element', { mod: 'value' })).to.be.equal(
        'block__element block__element--mod_value',
      )
    })
  })
